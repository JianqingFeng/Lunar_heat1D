...
% p: The output properties of each layer, including depth, thickness and density
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%% 
H=0.07;                            %h-parameter
rhos=1100;                         %Surface density
rhod=1800;                         %Density at depth
ks=8.0e-4;                         %ks is surface conductivity
kd=3.8e-3;                         %kd is deep conductivity
latitude=0;                        %Latitude
CHI=2.7;                           %Regolith radiative conductivity parameter (zero for rocks)
Malbedo=0.07;                      %Typical mare albedo
Halbedo=0.12;                      %Typicalhighland albedo
outtime=0:0.02:24;                 %Times to output
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
